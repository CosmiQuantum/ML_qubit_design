...
4. `plots`, `data`, `model`, `scalers`, and tuning directories contain experiment specific artifacts and cached outputs.
5. `metadata` holds saved names and config artifacts.
6. `results` groups training, prediction, validation, runtime, and cache outputs.
