...
2. `manuscript_exports` contains the generated figure files.
...
7. `build_manuscript_exports.py` rebuilds the data driven figure files from the exported experiment results.
